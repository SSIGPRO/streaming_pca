  ...
  arm_matrix_instance_f64 * pDst)
{
    ...
    float64_t *pDataA, *pDataB, *pDataDst;
    f64x4_t vecA, vecB, vecDst;
    float64_t const *pSrcAVec;
    float64_t const *pSrcBVec;
    uint32_t  blkCnt;           /* loop counters */

    pDataA = pSrcA->pData;
    pDataB = pSrcB->pData;
    pDataDst = pDst->pData;
    pSrcAVec = (float64_t const *) pDataA;
    pSrcBVec = (float64_t const *) pDataB;
